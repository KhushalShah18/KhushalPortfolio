  ...
  const skills = [
    {
      ...
      description: "Cloud platform expertise including various Azure resources, ARM templates, and serverless computing",
      badges: ["Web App", "APIM", "AKS"],
    ...
    },
    {
      ...
      badges: ["Terraform", "GitHub Actions"],
    ...
    },
    {
      ...
      badges: ["Ansible Automation", "NewRelic Monitoring"],
    ...
    },
    {
      ...
      badges: ["Docker", "Kubernetes", "Linux"],
    ...
    },
    {
      ...
      badges: ["Incident Response", "Vulnerability Management"],
    ...
    },
    {
      ...
      badges: ["Cost Optimization", "Budget Reporting"],
